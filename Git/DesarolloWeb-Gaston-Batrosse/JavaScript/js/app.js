...
var calculadora ={
    init:function(){
        ...
        punto.addEventListener('click',function(){
            ...
            var contador = pantalla.textContent;
        
            if (contador.indexOf(".") !== -1){
        ...
        sign.addEventListener('click',function(){
             ...
             var cadena1 = pantalla.textContent;
        
             if (cadena1.indexOf("-") !== -1){
        
                 pantalla.textContent= cadena2;
        
             }else {
                 cadena2=pantalla.textContent;
        
                 pantalla.textContent= numero + pantalla.textContent;
             }
